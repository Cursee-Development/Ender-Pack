package com.cursee.ender_pack.core.layer;
...
public class EnderPackFabricLayer<T extends LivingEntity, M extends HumanoidModel<T>> extends RenderLayer<T, M> {
  
  
  private final EnderPackFabricBagModel<T> bagModel;
  
  public EnderPackFabricLayer(RenderLayerParent<T, M> pRenderer) {
    super(pRenderer);
    
    bagModel = new EnderPackFabricBagModel<>(Minecraft.getInstance().getEntityModels().bakeLayer(EnderPackClient.ENDER_PACK_LAYER));
  }
