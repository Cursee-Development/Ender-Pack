...
public class EnderPackClient {
    ...
    public static final ModelLayerLocation ENDER_PACK_PLAYER_MODEL_LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.withDefaultNamespace("player"), "ender_pack");
